...
const LoginPage = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-zinc-950">
      ...
      >
        <div className="rounded-2xl border border-zinc-800/50 bg-zinc-900/80 p-10 shadow-2xl backdrop-blur-xl">
          {/* Logo */}
          <motion.div
          ...
          >
            <Button
              ...
              variant="outline"
              className="group relative w-full cursor-pointer overflow-hidden rounded-xl border-zinc-700 bg-zinc-800/50 px-6 py-6 text-base font-medium text-white transition-all duration-300 hover:border-zinc-600 hover:bg-zinc-800"
            >
          ...
          >
            ...
            <span className="cursor-pointer text-zinc-400 underline decoration-zinc-600 underline-offset-2 transition-colors hover:text-white">
              Terms of Service
            </span>{" "}
            and{" "}
            <span className="cursor-pointer text-zinc-400 underline decoration-zinc-600 underline-offset-2 transition-colors hover:text-white">
        ...
        <motion.div
          ...
          className="mt-8 flex justify-center gap-8 text-xs text-zinc-500"
        >
          {[
